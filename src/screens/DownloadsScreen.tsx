...
const styles = StyleSheet.create({
  ...
  appbarTitle: { flex: 1, fontSize: 26, fontWeight: '900', color: COLORS.text, letterSpacing: 1.5 },
  settingsBtn: {
    width: 36, height: 36, borderRadius: 10,
    backgroundColor: COLORS.card2,
    borderWidth: 1, borderColor: COLORS.border,
  ...
  emptyState: {
    ...
    paddingHorizontal: 32, paddingTop: 40, paddingBottom: 20,
  },
  ...
  emptySub: { fontSize: 13, color: COLORS.textSecondary, fontWeight: '300', lineHeight: 20, textAlign: 'center', marginBottom: 28 },
  browseBtn: {
  ...
  tipIcon: { width: 32, height: 32, borderRadius: 9, alignItems: 'center', justifyContent: 'center', flexShrink: 0 },
  ...
  checkboxLabel: { fontSize: 14, color: COLORS.text, fontWeight: '500' },
});
