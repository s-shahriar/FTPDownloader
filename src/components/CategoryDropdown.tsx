...
const styles = StyleSheet.create({
  ...
  catName: { fontSize: 14, fontWeight: '600', color: COLORS.text, lineHeight: 18, marginBottom: 1 },
  catCount: { fontSize: 10, color: COLORS.textSecondary, fontFamily: Platform.OS === 'ios' ? 'Menlo' : 'monospace' },
  ...
  modalTitle: { fontSize: 17, fontWeight: '700', color: COLORS.text, letterSpacing: 0.2 },
  listContainer: { padding: 10 },
  gridRow: { gap: 8 },
  gridItem: {
    flex: 1, backgroundColor: COLORS.card, borderRadius: 12,
    padding: 14, marginBottom: 8, borderWidth: 1.5, borderColor: 'transparent',
