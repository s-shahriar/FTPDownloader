...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 13, fontWeight: '600', color: COLORS.text, marginBottom: 3, lineHeight: 19 },
  statusRow: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  status: { fontSize: 11, fontWeight: '600', fontFamily: Platform.OS === 'ios' ? 'Menlo' : 'monospace' },
  categoryLabel: {
    fontSize: 9, color: COLORS.textDim, fontWeight: '500', marginTop: 2,
    letterSpacing: 0.5, textTransform: 'uppercase',
    fontFamily: Platform.OS === 'ios' ? 'Menlo' : 'monospace',
  },
  progressContainer: { marginTop: 12 },
  progressBarContainer: { height: 6, backgroundColor: COLORS.card2, borderRadius: 3, overflow: 'hidden' },
